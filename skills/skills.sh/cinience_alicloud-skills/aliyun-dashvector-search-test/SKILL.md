---
name: aliyun-dashvector-search-test
description: Smoke test for aliyun-dashvector-search. Validate minimal authentication, API reachability, and one read-only query path.
version: 1.0.0
---
...
- Target skill: `skills/ai/search/aliyun-dashvector-search/`.
...
python3 tests/common/compile_skill_scripts.py \
  --skill-path skills/ai/search/aliyun-dashvector-search \
  --output output/aliyun-dashvector-search-test/compile-check.json
```
...
4) Save request summary, response summary, and raw output under `output/aliyun-dashvector-search-test/`.
...
- Evidence files exist in `output/aliyun-dashvector-search-test/` with timestamp and parameters.

## Result Template

- Date: YYYY-MM-DD
- Skill: skills/ai/search/aliyun-dashvector-search
