---
name: aliyun-pai-workspace-test
description: Smoke test for aliyun-pai-workspace. Validate minimal authentication, API reachability, and one read-only query path.
version: 1.0.0
---
...
- Target skill: `skills/ai/platform/aliyun-pai-workspace/`.
...
python3 tests/common/compile_skill_scripts.py \
  --skill-path skills/ai/platform/aliyun-pai-workspace \
  --output output/aliyun-pai-workspace-test/compile-check.json
```
...
4) Save request summary, response summary, and raw output under `output/aliyun-pai-workspace-test/`.
...
- Evidence files exist in `output/aliyun-pai-workspace-test/` with timestamp and parameters.

## Result Template

- Date: YYYY-MM-DD
- Skill: skills/ai/platform/aliyun-pai-workspace
