---
name: aliyun-zimage-turbo-test
description: Smoke test for aliyun-zimage-turbo. Validate minimal authentication, API reachability, and one read-only query path.
version: 1.0.0
---
...
- Target skill: `skills/ai/image/aliyun-zimage-turbo/`.
...
python3 tests/common/compile_skill_scripts.py \
  --skill-path skills/ai/image/aliyun-zimage-turbo \
  --output output/aliyun-zimage-turbo-test/compile-check.json
```
...
4) Save request summary, response summary, and raw output under `output/aliyun-zimage-turbo-test/`.
...
- Evidence files exist in `output/aliyun-zimage-turbo-test/` with timestamp and parameters.

## Result Template

- Date: YYYY-MM-DD
- Skill: skills/ai/image/aliyun-zimage-turbo
