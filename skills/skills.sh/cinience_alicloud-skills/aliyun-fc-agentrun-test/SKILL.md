---
name: aliyun-fc-agentrun-test
description: Smoke test for aliyun-fc-agentrun. Validate minimal authentication, API reachability, and one read-only query path.
version: 1.0.0
---
...
- Target skill: `skills/compute/fc/aliyun-fc-agentrun/`.
...
python3 tests/common/compile_skill_scripts.py \
  --skill-path skills/compute/fc/aliyun-fc-agentrun \
  --output output/aliyun-fc-agentrun-test/compile-check.json
```
...
4) Save request summary, response summary, and raw output under `output/aliyun-fc-agentrun-test/`.
...
- Evidence files exist in `output/aliyun-fc-agentrun-test/` with timestamp and parameters.

## Result Template

- Date: YYYY-MM-DD
- Skill: skills/compute/fc/aliyun-fc-agentrun
