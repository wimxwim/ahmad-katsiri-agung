---
name: aliyun-milvus-search-test
description: Smoke test for aliyun-milvus-search. Validate minimal authentication, API reachability, and one read-only query path.
version: 1.0.0
---
...
- Target skill: `skills/ai/search/aliyun-milvus-search/`.
...
python3 tests/common/compile_skill_scripts.py \
  --skill-path skills/ai/search/aliyun-milvus-search \
  --output output/aliyun-milvus-search-test/compile-check.json
```
...
4) Save request summary, response summary, and raw output under `output/aliyun-milvus-search-test/`.
...
- Evidence files exist in `output/aliyun-milvus-search-test/` with timestamp and parameters.

## Result Template

- Date: YYYY-MM-DD
- Skill: skills/ai/search/aliyun-milvus-search
