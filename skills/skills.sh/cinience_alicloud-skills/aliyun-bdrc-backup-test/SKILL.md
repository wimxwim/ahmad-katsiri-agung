---
name: aliyun-bdrc-backup-test
description: Smoke test for aliyun-bdrc-backup. Validate minimal authentication, API reachability, and one read-only query path.
version: 1.0.0
---
...
- Target skill: `skills/backup/aliyun-bdrc-backup/`.
...
- Evidence files exist in `output/aliyun-bdrc-backup-test/` with timestamp and parameters.

## Result Template

- Date: YYYY-MM-DD
- Skill: skills/backup/aliyun-bdrc-backup
