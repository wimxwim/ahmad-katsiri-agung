---
name: aliyun-aimiaobi-generate-test
description: Smoke test for aliyun-aimiaobi-generate. Validate minimal authentication, API reachability, and one read-only query path.
version: 1.0.0
---
...
- Target skill: `skills/ai/content/aliyun-aimiaobi-generate/`.
...
python3 tests/common/compile_skill_scripts.py \
  --skill-path skills/ai/content/aliyun-aimiaobi-generate \
  --output output/aliyun-aimiaobi-generate-test/compile-check.json
```
...
4) Save request summary, response summary, and raw output under `output/aliyun-aimiaobi-generate-test/`.
...
- Evidence files exist in `output/aliyun-aimiaobi-generate-test/` with timestamp and parameters.

## Result Template

- Date: YYYY-MM-DD
- Skill: skills/ai/content/aliyun-aimiaobi-generate
