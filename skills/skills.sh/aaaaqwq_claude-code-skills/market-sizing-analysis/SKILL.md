...
description: "Use when the user asks to calculate TAM, determine SAM, estimate SOM, size a market, calculate market opportunity, ask for total addressable market, or do market sizing for a startup or business opportunity."
metadata:
  version: 1.0.0
risk: unknown
source: community
