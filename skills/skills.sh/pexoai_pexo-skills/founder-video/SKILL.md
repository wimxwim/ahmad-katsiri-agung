...
name: founder-video
description: >
  Make a founder video with Pexo — built for solo founders and small teams. Describe your story,
  product, or pitch (or paste your site) and Pexo writes the script, generates the shots, picks the
  models, and returns a finished, publish-ready founder video with music — for fundraising, Product
  Hunt, or your personal brand. Use for founder content: "founder video", "solo founder video",
  "founder pitch video", "founder story". NOT for paid ad campaigns (use the video-ad skill).
