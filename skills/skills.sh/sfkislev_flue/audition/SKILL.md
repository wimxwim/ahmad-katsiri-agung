---
name: Audition
description: Control Adobe Audition from the shell via Flue - ExtendScript bridges without an MCP server.
---
This skill lets a coding agent operate **Adobe Audition** on the desktop through [Flue](https://github.com/SFKislev/flue), a local shell-to-application bridge. The agent pipes ExtendScript into `audition_bridge.py` and gets structured JSON back.
