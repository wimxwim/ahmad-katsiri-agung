...
- **`bug-bounty`** — Master hunting methodology. See its `references/xenforo-recon.md` for XenForo forum recon (version timestamp fingerprinting, CVE-2026-35057, third-party JS audit).
