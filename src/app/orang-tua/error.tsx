  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="bg-glass border border-border-precision rounded-2xl p-8 sm:p-10 shadow-glass-lg max-w-md mx-auto text-center">
        ...
        <h1 className="font-heading text-xl font-bold text-on-surface mb-2">Dashboard Orang Tua tidak dapat dimuat</h1>
        <p className="text-sm text-on-surface-variant mb-6">
          Terjadi kesalahan saat memuat dashboard orang tua. Coba lagi dalam beberapa saat.
        </p>
        <button
          onClick={reset}
