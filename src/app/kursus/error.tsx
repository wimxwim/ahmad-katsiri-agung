...
export default function Error({
  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-5 lg:px-8 py-8">
      <div className="bg-glass border border-border-precision rounded-2xl p-8 sm:p-10 shadow-glass-lg max-w-md mx-auto text-center">
        ...
        <h1 className="font-heading text-xl font-bold text-on-surface mb-2">Katalog tidak dapat dimuat</h1>
        <p className="text-sm text-on-surface-variant mb-6">
          Terjadi kesalahan saat memuat katalog kursus. Coba lagi dalam beberapa saat.
        </p>
        <button
          onClick={reset}
