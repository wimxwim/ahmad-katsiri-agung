...
export const aiGeneration = pgTable("ai_generation", {
  ...
  publishedAt: timestamp("published_at", { withTimezone: true }),
  publishedMateriId: uuid("published_materi_id").references((): AnyPgColumn => materiPublished.id, { onDelete: "set null" }),
  publishedQuizId: uuid("published_quiz_id").references((): AnyPgColumn => quizPublished.id, { onDelete: "set null" }),
